...
public final class G2ConstraintLayout extends ConstraintLayout implements G2ViewRenderHost {
	...
	public G2ConstraintLayout(Context Context) {
		super(Context);
		InitializeG2(Context, null, 0);
	}
	
	public G2ConstraintLayout(Context Context, AttributeSet AttributeSet) {
		super(Context, AttributeSet);
		InitializeG2(Context, AttributeSet, 0);
	}
	
	public G2ConstraintLayout(Context Context, AttributeSet AttributeSet, int DefStyleAttr) {
